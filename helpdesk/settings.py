...
# show link to 'change password' on 'Ufser Settings' page?
...
if HELPDESK_VALID_EXTENSIONS:
    ...
    HELPDESK_VALID_EXTENSIONS = getattr(settings, 'HELPDESK_VALID_EXTENSIONS', [
        '.txt', '.asc', '.htm', '.html', '.pdf', '.doc', '.docx', '.odt', 
        '.jpg', '.jpeg', '.png', '.gif', '.bmp', '.tiff', '.svg', 
        '.xls', '.xlsx', '.csv', '.tsv', 
        '.zip', '.rar', '.7z', '.tar', '.gz', 
        '.mp3', '.wav', '.ogg', 
        '.mp4', '.avi', '.mkv', '.mov', 
        '.eml', '.json', '.xml', '.yaml', '.yml',
        '.mpp'
    ])
