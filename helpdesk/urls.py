...
urlpatterns = [
    path('user-autocomplete/', staff.user_autocomplete, name='user_autocomplete'),
    path('api/tickets/<int:ticket_id>/', staff.ticket_detail, name='api_ticket_detail'),  # New endpoint
