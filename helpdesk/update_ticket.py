...
def update_messages_sent_to_by_public_and_status(
    ...
    if public and (
        ...
        if ticket.assigned_to and ticket.assigned_to.usersettings_help_desk.email_on_ticket_change:
...
def update_ticket(
    ...
    if ticket.assigned_to and (
        ticket.assigned_to.usersettings_help_desk.email_on_ticket_change
        or (reassigned and ticket.assigned_to.usersettings_help_desk.email_on_ticket_assign)
    ):
